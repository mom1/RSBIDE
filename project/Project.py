...
import os
import copy
from RSBIDE.project.FileCache import FileCache
import RSBIDE.project.validate as Validate
...
class Project():
    ...
    def __init__(self, window, directory, project_settings, rsb_settings):
        """
            ...
            project_settings : Dictionary    - project settings (like project.settings.RSBIDE)
            rsb_settings : Dictionary        - config merge with base settings, specified by sublime-settings
        """
        self.window = window
    ...
    def set_setting(self, key, value):
        ...
        settings = data.get("settings").get("RSBIDE")
        settings[key] = value
